    ...
    {  
        ...
        {  
            ...
            private DialogInterface.OnClickListener positiveButtonClickListener, negativeButtonClickListener,  
                neutralButtonClickListener, itemButtonListener;  
            ...
            {  
                ...
                {  
                    ...
                    ((Button)layout.findViewById(R.id.negativeButton)).setBackgroundResource(buttonId);  
                    ((Button)layout.findViewById(R.id.neutralButton)).setBackgroundResource(buttonId);  
                }  
                if (buttonbackgroundId != -1)  
                {  
                    ((LinearLayout)layout.findViewById(R.id.mydialogbuttonlayout)).setBackgroundResource(buttonbackgroundId);  
                }  
                Mydialog.addContentView(layout, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));  
                if (title != null)  
                {  
                ...
                {  
                    ...
                    {  
                        ...
                        {  
                            ...
                            {  
                                positiveButtonClickListener.onClick(Mydialog, DialogInterface.BUTTON_POSITIVE);  
                ...
                {  
                    ...
                    {  
                        ...
                        {  
                            public void onClick(View v)  
                            {  
                                neutralButtonClickListener.onClick(Mydialog, DialogInterface.BUTTON_NEUTRAL);  
                                Mydialog.dismiss();  
                            }  
                        });  
                    }  
                ...
                {  
                    ...
                    {  
                        ...
                        {  
                            public void onClick(View v)  
                            {  
                                negativeButtonClickListener.onClick(Mydialog, DialogInterface.BUTTON_NEGATIVE);  
                                Mydialog.dismiss();  
                            }  
                        });  
                    }  
                ...
                if (negativeButtonText == null && neutralButtonText == null && positiveButtonText == null)  
                {  
                    ((LinearLayout)layout.findViewById(R.id.mydialogbuttonlayout)).setVisibility(View.GONE);  
                }  
                if (message != null)  
                {  
                ...
                {  
                    LinearLayout selflayout = ((LinearLayout)layout.findViewById(R.id.content));  
                    selflayout.removeAllViews();  
                    for (int i = 0; i < items.length; i++)  
                    {  
                        final int pos = i;  
                        TextView text = new TextView(context);  
                        text.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, 80));  
                        ...
                        {  
                            ...
                            textline.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, 1));  
                ...
                {  
                    ...
                    ((LinearLayout)layout.findViewById(R.id.content)).setPadding(left, top, right, bottom);  
